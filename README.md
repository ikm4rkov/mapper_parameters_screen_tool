NA/DNA мапперов**, **оценки производительности параметров картирования**, а также для **построения таблиц RNA–DNA контактов** из парных FASTQ-данных.

В состав входят:

- Полные пайплайны картирования для **STAR**, **Bowtie2**, **BWA** и **Hisat2**
- Монте-Карло скрининг параметров мапперов (STAR, Bowtie2)
