...
│
├── contacts_stats.cpp # Исходный код для пересечения ID и формирования метаданных для графиков
├── stats_wrapper.sh # Скрипт итерирования по файлам и параллелизации пересечения ID (все картировщики)
├── stats_wrapper_withonlybwa.sh # Скрипт итерирования по файлам и параллелизации пересечения ID (один картировщик, bwa в частности)
└── README.md
```
